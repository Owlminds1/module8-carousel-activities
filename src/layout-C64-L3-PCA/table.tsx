import TableData from "@/layout-C64-L2-PCA/table.json";
import React from "react";

const Table = () => {
  return (
    <div className="flex justify-center items-center ">
      <div className={`   gap-y-1 w-[70%] grid grid-cols-12 `}>
     ...
     Evaluation
      ...
      {TableData.map((item, index) => (
        <React.Fragment key={index}>
          <div className="col-span-6 w-full border text-xl font-bold flex justify-center items-center text-center p-2 ">
            {item.text}
          </div>

        
          <div className="col-span-6 w-full border flex flex-col justify-center items-center  text-center p-2 ">
