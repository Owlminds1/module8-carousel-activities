...
import SlideData from "@/layout-C64-L1-A3/pointer.json";
import Slide2Data from "@/layout-C64-L1-A3/pointer2.json";
              ...
              <div className="grid grid-cols-12 gap-y-10 place-items-center p-2">
                ...
                <div className=" col-span-6 w-full flex justify-center items-start flex-col gap-1 ">
                  <p className="text-2xl  font-normal text-black">
                    {" "}
                    A business plan is like a roadmap. It helps us to think and
                    explain the product in a better way. Even big companies make
                    business plans before launching something new!
                  </p>
