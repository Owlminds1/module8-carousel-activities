...
import SlideData from "@/layout-C57-L3-A1-A/pointer1.json";
import SlideData2 from "@/layout-C57-L3-A1-A/pointer3.json";
              ...
              <div className="grid grid-cols-12 place-items-center p-2">
                ...
                <div className=" col-span-6 w-full flex justify-center items-center flex-col gap-5 ">
                  <p className="text-black/80 text-2xl  w-full ">
                   “An entrepreneur is someone who starts their own business, especially when this involves seeing a new opportunity.” (Cambridge Dictionary)
                  </p>
                  <h3 className="text-black font-bold text-xl w-full">
                   ...
                   <p className="text-black/80 text-2xl  w-full ">
                  Shark Tank is a reality show that shows kid entrepreneurs making presentations to pitch their products. They present to five investors who can potentially be interested in helping these early-stage entrepreneurs.
                  </p>
              ...
              <div className="grid grid-cols-12 w-full place-items-center">
                <div className="col-span-12 w-full flex justify-center items-center">
                  <iframe
                    width="600"
                    height="400"
                    src="https://www.youtube.com/embed/TMDc-uISUew?si=J06ki8ZLGv9HrmVK"
