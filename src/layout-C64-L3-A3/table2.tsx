...
import DragData from "@/layout-C64-L3-A3/dragList.json";
import dropZone from "@/layout-C64-L3-A3/dropZone.json";
...
const Table2 = ({swiperRef}:myProps) => {
  ...
  return (
   <div className="flex flex-col gap-12 justify-center items-center ">
     <div className="grid grid-cols-12 gap-5 w-full ">
      ...
      <div
        className={`${shuffle.length === 0 ? "col-span-12" : "col-span-12"}  gap-1 w-full grid grid-cols-12 `}
      >
        ...
        {dropZone.map((drop, dropIndex) => (
          <React.Fragment key={dropIndex}>
            <div className="col-span-6 w-full text-xl text-black font-bold border flex justify-center items-center text-center p-2 ">
              {drop.text}
            </div>

            <div
              className="col-span-6 p-3 w-full h-full flex justify-center items-center border border-black/80 "
