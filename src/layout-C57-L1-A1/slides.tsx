...
import SlideData from "@/layout-C57-L1-A1/pointer1.json";
import SlideData2 from "@/layout-C57-L1-A1/pointer3.json";
        ...
        <div className="w-full shadow-md p-3 min-h-50 ">
          ...
          >
                ...
                <div className=" col-span-6 w-full flex justify-center items-center flex-col gap-5 ">
                  ...
                  <ul className="list-disc w-full space-y-3 px-2">
                    {SlideData.slice(0, visibleCount).map((item, index) => (
                      <li className="text-black text-lg animate_fadeInUp" key={index}>
                        {item}
                      </li>
                    ))}
                  </ul>
              ...
              <div className="grid grid-cols-12 w-full place-items-center">
                <div className="col-span-12 w-full flex justify-center items-center">
                  <iframe
                    width="600"
                    height="400"
                    src="https://www.youtube.com/embed/XQ4RESzO2wI?si=j-9zf8Iy9Ef6Gwth"
            ...
            <SwiperSlide>
              <div className="grid grid-cols-12 place-items-center p-2">
                <div className="col-span-6 w-full flex justify-center items-center ">
                  <MyImage path="/C57Images/Yummy_Brothers.png" />
                </div>
